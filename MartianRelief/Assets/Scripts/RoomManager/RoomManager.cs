...
public class RoomManager : MonoBehaviour
{
	...
	void Awake ()
	{
		if (instance != null) {
			...
			Debug.LogError ("Singleton RoomManager initialized twice!!");
		}
	}
	...
	GameObject getBossGameObject ()
	{
		...
		if (valToReturn < 0 || valToReturn >= prefabHolder.GetComponent<PrefabHolder> ().bossEnemies.GetLength (0)) {     //Random.value -> [0,1] inclusive!!
